...
Thanks for considering a contribution. This repo is a Claude Code plugin marketplace — most contributions will be either a new skill, a fix/improvement to an existing one, or a new plugin.
